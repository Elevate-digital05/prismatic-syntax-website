...
export const SERVICES = [
  {
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: 'Premium', price: 75000, plus: true, period: 'fully custom · no limits', desc: 'Bespoke builds and integrations.', feats: ['Discovery & strategy workshop', 'Unlimited pages', 'Custom functionality / API integrations', 'Full SEO strategy', 'Direct line to the founders throughout'] },
      ],
...

  {
    ...
    included: [
      ...
      { icon: 'card', name: 'Paystack integration', desc: 'Card payments in rands, settled to a South African bank account.' },
...

  {
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: 'Premium', price: 75000, plus: true, period: 'fully custom', desc: 'Multiple locations, complex rules, or integration with your existing system.', feats: ['Discovery & strategy workshop', 'Multi-location or multi-team scheduling', 'Custom functionality / API integrations', 'Integration with software you already use', 'Direct line to the founders throughout'] },
      ],
